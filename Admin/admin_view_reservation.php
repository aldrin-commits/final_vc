...
<head>
    ...
    <title>VC Café View Reservation</title>
    <link rel="stylesheet" href="admin_view_res_style.css">
    <!-- Include jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="admin_script.js" defer></script>

</head>
<body style = "background-color:#BCA788; ">
    <div class="container">
        <div class="admin-header">
            <h1 style="margin-top: 9px; margin-bottom: 9px">Reservation Details</h1>
            <div>
                <span style="margin-left: 100px; padding-left: 20px;">Welcome, <?php echo htmlspecialchars($_SESSION['admin_username']); ?></span>
                <a href="admin_index.php" class="btn" style="margin-left: 5px;margin-right: 5px">Back to Dashboard</a>
                <a href="admin_logout.php" class="btn logout-btn" style="margin-left: 5px; margin-right: 5px;">Logout</a>
            </div>
        </div>
            ...
            <div class="status-form">
                ...
                <form action="admin_view_reservation.php?id=<?php echo $reservation_id; ?>" method="post">
                    ...
                    <div class="action-buttons">
                        <button type="submit" name="confirm_reservation" class="btn btn-confirm" style="font-family: 'Poppins', sans-serif;" <?php echo ($reservation['reservation_status'] === 'confirmed') ? 'disabled' : ''; ?>>
                            Confirm Reservation
                        </button>
                        <button type="submit" name="cancel_reservation" class="btn btn-cancel" style="font-family: 'Poppins', sans-serif;" <?php echo ($reservation['reservation_status'] === 'cancelled') ? 'disabled' : ''; ?>>
                            Cancel Reservation
                        </button>
                        <button type="submit" name="pending_reservation" class="btn btn-pending" style="font-family: 'Poppins', sans-serif;" <?php echo ($reservation['reservation_status'] === 'pending') ? 'disabled' : ''; ?>>
                            Mark as Pending
                        </button>
                    </div>
                </form>
